  ...
  return (
    <>
      <SEO
        ...
        description="View Steven Brown's Full Stack Development Portfolio's Privacy Policy for more information on how my site uses and processes cookies."
      />

      <section className="relative p-16 mx-auto mt-24 prose bg-white shadow-md md:pb-12 max-w-7xl lg:prose-lg">
        <h1>Steven Brown&rsquo;s Full Stack Development Portfolio - Privacy Policy</h1>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              as the legal entity that collects Consumers&rsquo; personal information and
              determines the purposes and means of the processing of Consumers&rsquo; personal
              ...
              consumers&rsquo; personal information, that does business in the State of California.
            </p>
          </li>
          <li>
            <p>
              ...
              or &quot;Our&quot; in this Agreement) refers to Steven Develops Full Stack
          ...
          <li>
            <p>
              ...
              {' '}
              refers to: Massachusetts,  United States
            </p>
          </li>
          <li>
            <p>
              <strong>Data Controller</strong>
              , for the purposes of the GDPR (General Data Protection Regulation), refers to
              the Company as the legal person which alone or jointly with others determines the
          ...
          <li>
            <p>
              ...
              {' '}
              refers to Steven Brown&rsquo;s Full Stack Development Portfolio accessible from
              {' '}
              <a className="px-1 text-amber-600 hover:text-amber-800" href="https://stevendevelops.com" rel="external nofollow noopener noreferrer" target="_blank">https://stevendevelops.com</a>
            </p>
          </li>
          <li>
            <p>
        ...
        <ul>
          ...
          <li>
            ...
            {' '}
            <a className="px-1 text-amber-600 hover:text-amber-800" href="https://helpx.adobe.com/flash-player/kb/disable-local-shaamber-objects-flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_" rel="external nofollow noopener noreferrer" target="_blank">https://helpx.adobe.com/flash-player/kb/disable-local-shaamber-objects-flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_</a>
          </li>
          <li>
        ...
        <p>
          ...
          while Session Cookies are deleted as soon as You close Your web browser. Learn more
          about cookies:
          <a className="px-1 text-amber-600 hover:text-amber-800" href="https://www.whitehatsec.com/glossary/content/persistent-session-cookie#:~:text=Unlike%20other%20cookies%2C%20session%20cookies,Cookie%2C%20introducing%20a%20security%20risk." target="_blank" rel="noreferrer">Persistent Session Cookie by White Hat Sec</a>
          .
        </p>
        ...
        <ul>
          <li>
            ...
            <p>
              ...
              <a className="px-1 text-amber-600 hover:text-amber-800" href="https://policies.google.com/privacy" rel="external nofollow noopener noreferrer" target="_blank">https://policies.google.com/privacy</a>
            </p>
          </li>
        </ul>
        ...
        <ul>
          <li>
            ...
            <p>
              ...
              <a className="px-1 text-amber-600 hover:text-amber-800" href="https://www.google.com/intl/en/policies/privacy/" rel="external nofollow noopener noreferrer" target="_blank">https://www.google.com/intl/en/policies/privacy/</a>
            </p>
          </li>
        </ul>
        <h1>GDPR Privacy</h1>
        ...
        <ul>
          ...
          <li>
            ...
            . For example, third-party vendors to monitor and analyze the use of our Service,  or other third-party vendors that We use to provide the Service to You.
          </li>
        </ul>
        ...
        <ul>
          <li>
            <p>
              ...
              <Link className="px-1 text-amber-600 hover:text-amber-800" to="/contact">https://www.stevendevelops.com/contact-us</Link>
            </p>
          </li>
        </ul>
        ...
        <ul>
          <li>
            ...
            <a className="px-1 text-amber-600 hover:text-amber-800" href="http://www.networkadvertising.org/choices/" rel="external nofollow noopener noreferrer" target="_blank">http://www.networkadvertising.org/choices/</a>
          </li>
          <li>
            The EDAA's opt-out platform
            <a className="px-1 text-amber-600 hover:text-amber-800" href="http://www.youronlinechoices.com/" rel="external nofollow noopener noreferrer" target="_blank">http://www.youronlinechoices.com/</a>
          </li>
          <li>
            The DAA's opt-out platform:
            <a className="px-1 text-amber-600 hover:text-amber-800" href="http://optout.aboutads.info/?c=2&amp;lang=EN" rel="external nofollow noopener noreferrer" target="_blank">http://optout.aboutads.info/?c=2&amp;lang=EN</a>
          </li>
        </ul>
        ...
        <ul>
          <li>
            <p>
              By visiting this page on our website:
              <Link className="px-1 text-amber-600 hover:text-amber-800" to="/contact" rel="external nofollow noopener noreferrer" target="_blank">https://www.stevendevelops.com/contact</Link>
            </p>
          </li>
        </ul>
      </section>
